...
type Querier interface {
	...
	ListFaceBySessionID(ctx context.Context, id int64) ([]ListFaceBySessionIDRow, error)
	ListFaceBySessionIDAndEnrollmentPrimes(ctx context.Context, iD int64, column2 []string) ([]ListFaceBySessionIDAndEnrollmentPrimesRow, error)
