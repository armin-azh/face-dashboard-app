...
func (q *Queries) GetEventByPrime(ctx context.Context, prime string) (GetEventByPrimeRow, error) {
	row := q.db.QueryRow(ctx, getEventByPrime, prime)
	var i GetEventByPrimeRow
	err := row.Scan(
		&i.EventID,
		&i.EventPrime,
		&i.HappendAt,
